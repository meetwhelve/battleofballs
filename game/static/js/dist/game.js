...
class GamePlayground {
    ...
    show() {
        ...
        this.players = [];
        this.players.push(new Player(this, this.width / 2, this.height / 2, this.height * 0.05, "white", this.height * 0.15, true));                                              for (let i = 0; i < 5; i ++ ) {
...
<div class="game-settings">
    <div class="game-settings-login">
        ...
        <div class="game-settings-acwing">
            <img width="30" src="https://app32.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
            <br>
            <div>
                AcWing一键登录
            </div>
...
`);
	...
	acwing_login() {
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() {  // 在远程服务器上登录
        ...
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() {  // 在远程服务器上注册
        ...
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() {
        ...
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/logout/",
            type: "GET",
            success: function(resp) {
                console.log(resp);
                if (resp.result === "success") {
    ...
    getinfo_acapp() {
        ...
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
    ...
    getinfo_web() {
        ...
        $.ajax({
            url: "https://app32.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
